      ...
      <div class="app-content-body fade-in-up">
		...
		<div class="bg-light lter b-b wrapper-md">
		  <span class="pull-right" >
		  	<a href="results/settings"><button class="btn btn-default btn-addon  "><i class="fa fa-gear"></i>Results Settings </button></a>
		  </span>
		                ...
		                <div class="table-responsive">
		                  <table class="table table-striped table-hover b-t b-light">
							...
							<?php foreach($classes as $class){
		                      ...
		                      <tr>
		                        <td><?php echo $i; ?></td>
		                        <td><?php echo $class['class_details']; ?></td>
		                        <td><?php echo $class['lname'] . " ".$class['fname']. " ".$class['mname'] ; ?></td>
		                        <td><?php echo $class['no_of_student']; ?></td>
		                        <td><?php echo $class['no_of_processed']; ?></td>
