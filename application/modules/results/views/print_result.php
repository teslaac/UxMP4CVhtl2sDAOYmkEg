		...
		<div class="cont">
			...
			<section>
				...
				<div class="col-sm-12">
					...
					<tbody>
						<tr>
							<td class="h4"><b>Name: ABIODUN ABISOYE OLAWALE </b></td>
							<td class="h4"><b> Admission No: 01234567 </b></td>
						</tr>
					</tbody>
				</table>
				</div>
				...
				<div class="col-sm-12">
					<table class="table table-hover">
						<thead>
							<tr style="background:#D9EDF7">
								<th valign="bottom" width="100" >Subjects</th>
								<th valign="bottom" width="40"> Max</th>
					...
					<table class="table table-hover">
						<tbody>
							<tr>
								<td width="100px">1st Term Score</td>
								<td width="40">100</td>
								<td>-</td>
								<td>-</td>
								<td>-</td>
