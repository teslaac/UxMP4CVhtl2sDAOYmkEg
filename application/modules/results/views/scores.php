					...
					<table class="table table- b-t b-light">
						...
						if(isset($class_students)){
							foreach($class_students as $class_student) {
								...
								$status[$i] = $this->result->no_processed_result(array('subject_id'=>$class_student['subject_id'],'class_details_id'=>$class_student['admission_class_details_id']));
								if($status[$i] == 0){
									$cs = 'danger';
								...
								<tr>
									...
									<td><a href="scores/process/<?php echo $class_student['subject_id']; ?>/<?php echo $class_student['admission_class_details_id']; ?>" class="btn btn-xs btn-info"><i
												class="fa fa-pencil"></i> Process Exam Scores</a></td>
									<td>
										<button class="btn btn-xs btn-dark"><i class="fa fa-pencil"></i> Edit</button>
									</td>
								</tr>
								<?php
									$i++;
