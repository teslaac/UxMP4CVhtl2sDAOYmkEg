          ...
          <?php for ($i=1; $i <= $no ; $i++) {
            ...
            <tr>
              ...
              <?php echo form_error("title$i"); ?>
				...
				<option <?php echo set_select('title$i','MR.',((('MR.') == ($title))?true:false)); ?> value="MR.">MR.</option>
				<option <?php echo set_select('title$i','MRS.',((('MRS.') == ($title))?true:false)); ?> value="MRS.">MRS.</option>
				<option <?php echo set_select('title$i','MISS.',((('MISS.') == ($title))?true:false)); ?> value="MISS.">MISS.</option>
				<option <?php echo set_select('title$i','DR.',((('DR.') == ($title))?true:false)); ?> value="DR.">DR.</option>
				<option <?php echo set_select('title$i','PROF.',((('PROF.') == ($title))?true:false)); ?> value="PROF.">PROF.</option>
									</select>
              </td>
              <td>	
