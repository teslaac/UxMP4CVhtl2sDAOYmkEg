              ...
              <div class="table-responsive">
                <table class="table panel panel-info">
                  ...
                  ?>
                        ...
                        <td>
                          <select name="session_id" id="input session_id" class="form-control" required="required">
                            
                             <option <?php echo set_select('session_id','',TRUE); ?> value="">Select</option>
                  <?php
                  foreach ($session_details as $session_detail) {
                    ?>
                    <option <?php echo set_select('session_id', "session_detail[session_id]"); ?> value="<?php echo $session_detail['session_id'];?>"><?php echo $session_detail['session_name']; ?>
                    </option>
                    <?php
                  }
                  ?>
