                          ...
                          <table class="table table-striped b-t b-light">
                            ...
                            ?>
                              <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_term_session/<?php echo $ts_detail['id']; ?>/inactive/ts_active/" class="btn btn-xs btn-danger"><i class="fa fa-check"></i> Disable</a> </td>
                                <?php }else{?>
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_term_session/<?php echo $ts_detail['id']; ?>/active/ts_active/" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Enable</a> </td>
                                <?php } ?>
                              </tr>
                                <?php
                                $i++;}}else{
