                            ...
                            ?>
                              <tr>
                               ...
                               <td><a href="#term-modal" data-toggle="modal" class="btn btn-xs btn-primary editt"><i class="fa fa-pencil"></i> Edit</a></td>
                                ...
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_term/<?php echo $term_detail['id']; ?>/inactive/status" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> Disable</a> </td>
                                <?php }else{?>
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_term/<?php echo $term_detail['id']; ?>/active/status" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Enable</a> </td>
                                  <?php }?>
                              </tr>
                            <?php
                            $i++;}}else{
