                          ...
                          <table class="table table-striped b-t b-light">
                            ...
                            ?>
                              <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_session/<?php echo $session_detail['id']; ?>/inactive/session_active" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> Disable</a> </td>
                                <?php }else{?>
                                <td><a href="<?php echo base_url(); ?>core/status/acadah_school_session/<?php echo $session_detail['id']; ?>/active/session_active" class="btn btn-xs btn-success"><i class="fa fa-check"></i> Enable</a> </td>
                                  <?php }?>
                              </tr>
                              <?php 
                           $i++; }
