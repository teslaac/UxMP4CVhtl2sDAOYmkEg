	                ...
	                <tbody>
						...
						foreach($students as $student) {
							...
							<tr>
								...
								<td><?php echo $i; ?></td>
								<td><?php echo strtoupper($student['lname']); ?></td>
								<td><?php echo strtoupper($student['fname']); ?></td>
								<td><?php echo strtoupper($student['class_details']); ?></td>
								<td><?php echo number_format($student['pamount']); ?></td>
								...
								<td><a href="fees/payments/process/<?php echo $student['user_id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-dollar"></i> Process </a>
