...
//  $lname = $user_info['lname'] = $_SESSION['lname'];
//  $mname = $user_info['mname'] = $_SESSION['mname'];
?>
<!-- content -->
            ...
            <div class="col">
                ...
                <div class="col w-md wrapper bg-light dk hf">
                    <ul class="nav nav-pills nav-stacked nav-sm aside">
                        ...
                        <li  class=""><a href="#"><i class="fa fa-fw fa-print"></i> Parent Info</a></li>
                    ...
                    <section class="panel panel-default clearfix ">
                        <div class="step-content">
                            <div class="step-pane active" id="step4">
                                ...
                                <?php echo validation_errors();  print_r($parent_data); ?>
                            ...
                            <?php echo $parent_id = $parent_data['parent_id'];
                                    ...
                                    <?php echo form_open("admission/save_parent/$parent_id", $data); ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control" name="pgender" >
                                                            <option value="Male" <?php if($parent_data['gender'] == 'Male'){echo 'selected';} ?>>Male</option>
                                                        <option value="Female" <?php if($parent_data['gender'] == 'Female'){echo 'selected';} ?>>Female</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea class="form-control" value="<?php echo $parent_data['address']; ?>"rows="2" name="faddress"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea class="form-control" value="<?php echo $parent_data['occupation_address']; ?>" rows="2" name="ocaddress"><?php echo $parent_data['occupation_address']; ?></textarea>
                                                    </div>
                                                </div>
                       ...
                       <section class="panel panel-default">
                                ...
                                <div class="table-responsive">
                                  <table class="table table-striped b-t b-light">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td><?php //echo $parent_data['fname']; ?></td>
                                        <td><?php //echo $parent_data['lname']; ?></td>
                                        <td>NGN103,465.00</td>
                                        <td><span class="text-info">PENDING</span></td>
                                        <td>11/11/2014 9:38</td>
                                        <td><a href="#" class="btn btn-xs btn-dark"><i class="fa fa-print"></i> Print Profile</a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
