    ...
    <div class="app-content">
      ...
      <?php if($this->session->flashdata('Success')){ ?>
        <div class="alert alert-info fade in widget-inner text-center">
            ...
            Success. <a href="<?php echo base_url(); ?>/admission/admin/view_terms_condition">Click here to go back</a>
        </div>
        <?php } ?>
...
<?php foreach ($edit_terms_condition as $edits); ?>
	<div class="line line-dashed b-b line-lg"></div>
  <form action="<?php echo base_url(); ?>admission/edit_terms_condition/<?php echo $edits['id']; ?>" method="post">
     <div class="form-group m-b clearfix">
        <label class="col-sm-2 control-label">Name: <span>*</span></label>
        <div class="col-sm-10">
            <input class="form-control" value="<?php echo $edits['sch_admin_name']; ?>" name="name" type="text">
        </div>
    </div>
    ...
    <div class="form-group m-b clearfix">
      <label class="col-sm-2 control-label">  Content: <span>*</span></label>
        <div class="col-sm-10">
        <textarea id="edit"  name="content"><?php echo $edits['content']; ?></textarea>
     </div>
  </div>
  <div class="line line-dashed b-b line-lg"></div>
