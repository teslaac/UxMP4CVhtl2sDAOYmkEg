...
?><!DOCTYPE html>
    ...
    <div class="app-content">
      ...
      <div class="app-content-body fade-in-up">
		...
		<div class="bg-light lter b-b wrapper-md">
		  ...
		  <h1 class="m-n font-thin h3">Terms And Condition</h1>
		</div>
 ...
 <div class="table-responsive">
  ...
  <form action="<?php echo base_url(); ?>/admission/create_term_condition" method="post">
  ...
  <div class="line line-dashed b-b line-lg"></div>
        ...
        <div class="form-group">
          <div class="col-sm-4 col-sm-offset-2">
            <a href="<?php echo base_url(); ?>admission/admin/view_terms_condition"><button type="button" class="btn btn-default">Cancel</button></a>
