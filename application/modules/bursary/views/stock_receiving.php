							...
							<li class="list-group-item nopadding">
								...
								<div class="widget-box no_left_right_border">
									...
									<div class="widget-title">
										<h5>Select Supplier (Optional)</h5>
									</div>
									
									
									<div class="widget-content">
										<div id="customer_info_shell">
											<form action="http://localhost/stockah2/index.php/receivings/select_supplier" method="post" accept-charset="utf-8" id="select_supplier_form" autocomplete="off">								
											<span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
											<input type="text" name="supplier" value="Type supplier's name..." id="supplier" size="30" class="form-control" autocomplete="off">									
											</form>
											<div id="add_customer_info">
												<div id="common_or">
													OR&nbsp;<a href="http://localhost/stockah2/index.php/suppliers/view/-1/1" id="new-supplier" class="btn btn-primary none" title="New Location"><div class="small_button" style="margin:0 auto;">
													<span>New Supplier</span></div></a>											
												</div>
									...
									<div id="finish_sale">
										...
										<div id="make_payment">
											<table id="make_payment_table" class="table">
												<tbody><tr id="mpt_top" class="success ">
													<td>
														Payment Type:   	
										...
										<div style="padding: 0 10px 0 10px;">
											...
											<textarea class="form-control" name="comment" cols="40" rows="4" id="comment"></textarea>							
