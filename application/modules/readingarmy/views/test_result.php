                ...
                <div class="bg-light lter b-b wrapper-md">
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <h1 class="m-n font-thin h3 text-black ">Test Result</h1>
                    ...
                    <section class="panel panel-default clearfix ">
                        <div class="step-content">
                            <div class="step-pane active" id="step4">
                                ...
                                <div class="col-md-12">    
                                    <div class="panel">
                                      <div class="panel-heading text-info h3">TEST RESULT ~ BURT GELLER <span class="font-thin"> by Adesola Adeola  </div>
                                      <div class="m-t">
