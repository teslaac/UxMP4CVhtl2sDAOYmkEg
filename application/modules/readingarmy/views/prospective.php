                        ...
                        <div class="step-content">
                            <div class="step-pane active" role="tabpannel" id="apply">
                                ...
                                <div class="alert alert-info fade in widget-inner">
                                    ...
                                    Username: <b><?php echo $this->session->flashdata('sch_id'); ?></b>
                                    Pasword: <b><?php echo $this->session->flashdata('surname'); ?></b>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php echo form_open('admission/register/apply', $data); ?>
